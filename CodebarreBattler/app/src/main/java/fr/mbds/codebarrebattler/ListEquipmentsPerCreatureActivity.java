    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listEquipments.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Equipement e = (Equipement) adapter.getItem(i);

               // Toast.makeText(getApplicationContext(), "adapter id db "+e.getId(), Toast.LENGTH_LONG).show();
                Intent intent = new Intent(ListEquipmentsPerCreatureActivity.this,EquipmentDetailActivity.class);
                intent.putExtra("detailEquip",e);
